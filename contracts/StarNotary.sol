...
contract StarNotary is ERC721Full {
    ...
    constructor() ERC721Full("Constelation", "CON") public {}
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        ...
        string memory starName = newStar.name;
        return (starName);
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1) == msg.sender || ownerOf(_tokenId2) == msg.sender, "You can't sell a Star you don't own");
